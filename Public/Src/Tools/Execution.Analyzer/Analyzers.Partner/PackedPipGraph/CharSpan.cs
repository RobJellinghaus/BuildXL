...
namespace BuildXL.Execution.Analyzers.PackedPipGraph
{
    ...
    public struct CharSpan
    {
        ...
        /// <summary>
        /// Create a CharSpan over part of an underlying string.
        /// </summary>
        ...
        public struct EqualityComparer : IEqualityComparer<CharSpan>
        {
            ...
            public bool Equals([AllowNull] CharSpan x, [AllowNull] CharSpan y) =>
                x.AsSpan(StringTable).CompareTo(y.AsSpan(StringTable), StringComparison.InvariantCulture) == 0;

            private static int CharToInt(char c) => c;

            public int GetHashCode([DisallowNull] CharSpan obj) => SpanUtilities.GetHashCode(obj.AsSpan(StringTable), CharToInt);
        }
    }
}
